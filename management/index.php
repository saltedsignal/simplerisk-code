      ...
      <div class="row-fluid">
        <div class="span3">
          <ul class="nav  nav-pills nav-stacked">
            ...
            <li <?php if($_GET['page'] == '1' || $_GET['page'] == '7') { ?>class="active"<?php } ?>>
              <a href="index.php?module=1&page=1">II. <?php echo $lang['PlanYourMitigations']; ?></a> 
            </li>
            <li <?php if($_GET['page'] == '2' || $_GET['page'] == '6') { ?>class="active"<?php } ?>>
            ...
            <li <?php if($_GET['page'] == '4' || $_GET['page'] == '5' || $_GET['page'] == '8' || $_GET['page'] == '10' || $_GET['page'] == '11') { ?>class="active"<?php } ?>>
